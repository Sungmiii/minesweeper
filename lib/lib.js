...
function initBoard () {
  ...
  displayMessage("There is my <strong>little dog</strong> in this game!<br>If you find him you lose though...,<br>but he is cute.")
...
function showCell (evt) {
  ...
  if (evt.target.classList.contains('mine')) {
    displayMessage('You found him, and you lose!')
    music.play();
    revealMines()
    removeListeners()
    return 
